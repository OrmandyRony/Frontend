		...
		<div class="row">
			<div class="col-md-4">
                <form>
                    ...
                    <center>
                        <button type="button" class="btn btn-success" onclick="agregarFuncion()">Registrar Función</button>  
                    </center>                 
                </form>
            </div>
        </div>
...
<script>
    ...
    var ruta = 'https://proyectocinella.herokuapp.com/obtenerPeliculas';
      ...
      console.log(nombres)
      var html = '<select class="form-control" name="" id="pelicula">'
